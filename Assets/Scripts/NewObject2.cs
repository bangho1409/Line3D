...
{
    public class NewObject2 : MonoBehaviour
    {
        ...
        void CreateObjects()
        {
            ...
            {
                Vector3 objectPosition = new Vector3(Random.Range(0, 13), 1, Random.Range(0, 13));
            ...
            void SpawnGameObject()
            {
                ...
                foreach (SpawnObject item in spawnObjectList)
                {
                    ...
                    Vector3 spawnPosition = new Vector3(Random.Range(0, 13), 1, Random.Range(0, 13));
